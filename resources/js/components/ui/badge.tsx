...
const badgeVariants = cva(
  "inline-flex min-h-6 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border px-2.5 py-0.5 text-xs font-semibold whitespace-nowrap transition-[background-color,border-color,color] duration-150 ease-out [&>svg]:size-3 [&>svg]:pointer-events-none focus-visible:ring-ring/10 focus-visible:ring-[3px] aria-invalid:border-danger",
  {
    variants: {
      variant: {
        default:
