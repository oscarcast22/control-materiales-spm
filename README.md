...
- Aplicaciones parciales o en bloque con tipo y número de orden de servicio, ubicación o dirección libre, detalles y saldo por partida.
- Anulación auditada de movimientos, registro mínimo y corrección de folios físicos prestados, y cancelación controlada de vales con clasificación del material sin usar.
- Fotos o PDF del vale guardados en almacenamiento privado.
- Consulta por folio u orden de servicio, filtros, impresión y exportación XLSX del seguimiento de material.
...
- `material_application_reports`: fecha, tipo y número de orden, ubicación o dirección libre, detalles y evidencia opcional de una aplicación capturada en bloque.
