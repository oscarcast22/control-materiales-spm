...
9. Si un formato físico fue prestado, se registra su tipo, folio y fecha. Opcionalmente conserva el técnico relacionado, el nombre libre de la persona responsable y una o más partidas con las cantidades prestadas. Estos datos son editables por la administradora, no generan saldo pendiente y no admiten aplicaciones ni devolución.
...
- Registro y corrección auditada de folios prestados, con técnico, persona responsable y materiales opcionales.
