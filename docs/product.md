...
- Administración del acceso técnico desde Personas: alta automática, pausa/reactivación y restablecimiento al número de cobro. Al confirmar un alta o administrar una cuenta, la administradora ve el usuario y el número de cobro que determina la contraseña; esos datos no se muestran en la tabla, avisos ni auditorías, y el técnico no puede cambiar la contraseña.
